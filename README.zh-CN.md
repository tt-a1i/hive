...
[![Platforms](https://img.shields.io/badge/platforms-macOS%20%7C%20Linux%20%7C%20Windows-lightgrey.svg)](#平台支持)

[English](./README.md) · 简体中文

> Public preview：`0.6.0-alpha.0`。Hive 是本机优先的工具，只监听 `127.0.0.1`，面向已经在用 CLI Coding Agent 的开发者。
...
| Windows | Tier 1 | CI 持续验证。目录选择器走 Windows PowerShell，包内带了 `team.cmd` |
